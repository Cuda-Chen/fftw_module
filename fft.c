...
/* Calculate FFT and output the amplitude and phase to file.
 * Input: input array `data`, length of array `dataSamples`,
 *        sampling rate of data `sampleRate`, output FILE pointer `fptr`
 * Output: none
 */
void
